...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        mainWindow.resize(1159, 979)
        self.S = Steganography()
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(410, 500, 221, 51))
        self.pushButton_4.setStyleSheet("font: 12pt \"Times New Roman\";")
        self.pushButton_4.setObjectName("pushButton_4")
        self.six_point = QtWidgets.QLabel(self.centralwidget)
        self.six_point.setGeometry(QtCore.QRect(20, 670, 281, 311))
        self.six_point.setObjectName("six_point")
        self.lsb_layer = QtWidgets.QLabel(self.centralwidget)
        self.lsb_layer.setGeometry(QtCore.QRect(390, 660, 281, 311))
        self.lsb_layer.setObjectName("lsb_layer")
        self.label_7 = QtWidgets.QLabel(self.centralwidget)
        self.label_7.setGeometry(QtCore.QRect(10, 560, 241, 31))
        self.label_7.setStyleSheet("font: 12pt \"Times New Roman\";")
        self.label_7.setObjectName("label_7")
        self.label_8 = QtWidgets.QLabel(self.centralwidget)
        self.label_8.setGeometry(QtCore.QRect(410, 550, 241, 31))
        self.label_8.setStyleSheet("font: 12pt \"Times New Roman\";")
        self.label_8.setObjectName("label_8")
        self.lsb_layer_2 = QtWidgets.QLabel(self.centralwidget)
        self.lsb_layer_2.setGeometry(QtCore.QRect(780, 650, 281, 311))
        self.lsb_layer_2.setObjectName("lsb_layer_2")
        self.label_9 = QtWidgets.QLabel(self.centralwidget)
        self.label_9.setGeometry(QtCore.QRect(780, 550, 241, 31))
        self.label_9.setStyleSheet("font: 12pt \"Times New Roman\";")
        self.label_9.setObjectName("label_9")
        self.comboBox_antrops = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_antrops.setGeometry(QtCore.QRect(50, 600, 161, 21))
        self.comboBox_antrops.setObjectName("comboBox_antrops")
        ...
        self.comboBox_antrops.addItems(antoposPoints())
        self.comboBox_lasb.addItems(get_lsb_layers())
        ...
        pixmap = QtGui.QPixmap(self.comboBox_antrops.currentText())
        pixmap2 = pixmap.scaled(256, 256, QtCore.Qt.KeepAspectRatio)
        self.six_point.setPixmap(pixmap2)

        pixmap = QtGui.QPixmap(self.comboBox_lasb.currentText())
        pixmap2 = pixmap.scaled(256, 256, QtCore.Qt.KeepAspectRatio)
        self.lsb_layer.setPixmap(pixmap2)
        ...
        self.comboBox_antrops.currentIndexChanged.connect(self.on_combobox_changed_antropos)
        self.comboBox_lasb.currentIndexChanged.connect(self.on_combobox_changed_lsb)
    ...
    def on_combobox_changed_antropos(self):
        pixmap = QtGui.QPixmap(self.comboBox_antrops.currentText())
        pixmap2 = pixmap.scaled(256, 256, QtCore.Qt.KeepAspectRatio)
        self.six_point.setPixmap(pixmap2)

    def on_combobox_changed_lsb(self):
        pixmap = QtGui.QPixmap(self.comboBox_lasb.currentText())
        pixmap2 = pixmap.scaled(256, 256, QtCore.Qt.KeepAspectRatio)
        self.lsb_layer.setPixmap(pixmap2)
    def retranslateUi(self, mainWindow):
        ...
        self.six_point.setText(_translate("mainWindow", "TextLabel"))
    ...
    def showPicts(self):
        ...
        self.comboBox_antrops.addItem(antoposPoints()[-1])

    def cryptPics(self):
        self.comboBox_3.addItem(self.S.embed(self.comboBox.currentText(), self.comboBox_2.currentText(), 1,1))

    def encryptPics(self):
        self.comboBox_lasb.addItem(self.S.extract(self.comboBox_3.currentText(), 1,1))
        # self.comboBox_lasb.addItem(get_lsb_layers()[-1])
    #     for i in lister:
